...
public:
    ...
    static const char KEY_CONTINOUS_SHOT_PATH[];
    static const char KEY_CONTINOUS_SHOT_MAX_COUNT[];
    static const char KEY_CONTINOUS_SHOT_MIN_INTERVAL[];	

    //add by lzy 2013.5.23
    static const char KEY_CONTINOUS_SHOT_SPPORTED[];
    static const char KEY_BURST_SHOT_SPPORTED[];
    //add by lzy 2013.5.28
    static const char KEY_SMILE_SHOT_SPPORTED[];
    static const char KEY_ANTIBLINK_SHOT_SPPORTED[];

    static const char KEY_SHUTTER_MODE_SPPORTED[];
    ...
    static const char KEY_EDGE_ENHANCE[];
    static const char KEY_NOISE_REDUCTION[];
    static const char KEY_CONTRAST_ENHANCE[];
    static const char KEY_ZSL_CAPTURE[];
    static const char KEY_BLINK[];
    ...
    static const char ISO_1200[];	
    static const char ISO_1600[];

    //Values for wdr
    static const char WDR_ON[];
    static const char WDR_OFF[];

    //Values for edge enhance
    static const char EDGE_ENHANCE_ON[];
    static const char EDGE_ENHANCE_OFF[];

    //Values for noise reduction
    static const char NOISE_REDUCTION_ON[];
    static const char NOISE_REDUCTION_OFF[];
    ...
    static const char ZSL_CAPTURE_ON[];
    static const char ZSL_CAPTURE_OFF[];

    //Values for metering mode
    static const char METERING_AVERAGE[];
